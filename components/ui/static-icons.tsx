...
export function YoutubeIcon(props: IconProps) {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={props.size ?? 24} height={props.size ?? 24} fill="currentColor" className={props.className} aria-hidden={props["aria-hidden"]} style={{ color: props.color, ...props.style }}><path d="M23.5 6.19a3.02 3.02 0 0 0-2.12-2.14C19.5 3.55 12 3.55 12 3.55s-7.5 0-9.38.5A3.02 3.02 0 0 0 .5 6.19C0 8.08 0 12 0 12s0 3.92.5 5.81a3.02 3.02 0 0 0 2.12 2.14c1.88.5 9.38.5 9.38.5s7.5 0 9.38-.5a3.02 3.02 0 0 0 2.12-2.14C24 15.92 24 12 24 12s0-3.92-.5-5.81zM9.55 15.57V8.43L15.82 12l-6.27 3.57z" /></svg>;
}

export function SpotifyIcon(props: IconProps) {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={props.size ?? 24} height={props.size ?? 24} fill="currentColor" className={props.className} aria-hidden={props["aria-hidden"]} style={{ color: props.color, ...props.style }}><path d="M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24zm5.5 17.3a.75.75 0 0 1-1.03.25c-2.82-1.72-6.37-2.11-10.55-1.16a.75.75 0 1 1-.34-1.46c4.57-1.04 8.5-.6 11.67 1.34.35.21.46.67.25 1.03zm1.47-3.27a.94.94 0 0 1-1.29.31c-3.23-1.98-8.15-2.56-11.97-1.4a.94.94 0 1 1-.55-1.8c4.37-1.32 9.78-.67 13.5 1.6.44.27.58.85.31 1.29zm.13-3.4C15.3 8.5 8.9 8.29 5.2 9.4a1.12 1.12 0 1 1-.65-2.15C8.8 6.04 15.9 6.3 20.4 9.07a1.12 1.12 0 0 1-1.15 1.93l-.15-.09z" /></svg>;
}

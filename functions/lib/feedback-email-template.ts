// GENERATO da `npm run email:template` — non modificare a mano.
...
<a href="https://mattiaciuni.pages.dev/feedback/" style="display:block;text-decoration:none;">
<div class="email-header" style="box-sizing:border-box;background-color:#161616;background-image:url(https://mattiaciuni.pages.dev/email-header.png);background-position:center center;background-repeat:no-repeat;background-size:cover;border-radius:16px;height:264px;padding:170px 32px 0;text-align:center;font-family:Inter,Arial,sans-serif;">
<p style="margin:0;font-family:'Instrument Serif',Georgia,serif;font-size:30px;line-height:1.08;letter-spacing:-0.02em;color:#ffffff;font-weight:400;">Thank you for the feedback</p>
</div>
</a>
<!--[if mso]>
</v:textbox></v:rect>
